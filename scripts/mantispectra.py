...
class SpectrometerDriver():
    def __init__(self):
        ...
        # Initialize the Spectrapod the Baudrate must equal 115200
        self.spectrapod = serial.Serial(self.port_path, baudrate=115200)
        self.spectrapod.flushInput()
        self.spectrapod.flushOutput()
        self.spectrapod.write(self.start_light_power.encode())
        self.spectrapod.write('ffv'.encode())
    ...
    def set_light_power(self, power: Light) -> LightResponse:
        ...
        self.spectrapod.write(powerToSend.encode())
        self.spectrapod.flush()
    ...
    def set_integration_time(self, intTime: Integration) -> IntegrationResponse:
        ...
        try:
            ...
            self.spectrapod.write(formattedTime.encode())
            self.spectrapod.flush()
    ...
    def run(self) -> None:
        ...
        while not rospy.is_shutdown():
            try:
                # Grab the raw data
                raw_data = self.spectrapod.read_until(b'\r')
    ...
    def shutdown(self):
        ...
        '''
        # Turn off the light
        self.spectrapod.write('0v'.encode())
        # Close the serial transmission
        self.spectrapod.close()
